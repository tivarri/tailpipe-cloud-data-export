...
echo "Generating tailpipie-dataexport-report-definition.json"
cat <<EOT > tailpipie-dataexport-report-definition.json
{
  "DataQuery": {
...
EOT
echo "tailpipie-dataexport-report-definition.json generated" \
    ...
    "Statement": [
        {
            "Effect": "Allow",
            "Principal": {
                "AWS": "arn:aws:iam::336268260260:role/TailpipeConnector"
            },
...
aws bcm-data-exports create-export --export file://tailpipie-dataexport-report-definition.json
